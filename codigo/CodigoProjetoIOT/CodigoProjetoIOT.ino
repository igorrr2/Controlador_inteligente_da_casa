...
#define TOPICO_SUBSCRIBE_CHUVA "TOPICO_SUBSCRIBE_sssVERIFICA_CHUVA"
#define TOPICO_PUBLISH_LED         "topico_liga_desliga_led"
#define TOPICO_SUBSCRIBE_ULTRASSONICO "TOPICO_SUBSCRIBE_ULTRASSONICO"
#define ID_MQTT  "DIGITE O ID MQTT"     //id mqtt (para identificação de sessão)
////////////////////////////////////////////////////////////////////////////////////////////////////////
Ultrasonic ultrasonic(PORTA_TRIGGER, PORTA_ECHO);
// declarar variável distancia do tipo inteiro sem sinal
float distancia;

const char* SSID     = "COLOQUE SUA REDE WIFI"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "SENHA DA REDE WIFI"; // Senha da rede WI-FI que deseja se conectar
